...
var hidderInput = document.querySelector('#hiddenInput');
var order = hidderInput ? hidderInput.value : null;
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (stepCompleted) {
      status.classList.add('step-completed'); //console.log(status)
    }
...
__webpack_require__(/*! D:\pizza\realtime-pizza\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\pizza\realtime-pizza\resources\scss\app.scss */"./resources/scss/app.scss");
